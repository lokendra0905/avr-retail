...
export function Timeline() {
  return (
    <section className="py-24 border-t border-navy-700">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="relative mx-auto max-w-5xl">
          <div
            className="absolute bottom-0 left-4 top-0 w-px bg-gold-500/30 md:left-1/2 md:-translate-x-px"
            aria-hidden
          />
              ...
              return (
                <AnimatedSection key={item.year} delay={i * 0.05}>
                  <div className="relative md:grid md:grid-cols-2 md:items-center md:gap-12">
                    ...
                    <div
                      className="absolute left-4 top-6 z-10 flex h-9 w-9 -translate-x-1/2 items-center justify-center rounded-full border-2 border-gold-500 bg-navy-800 text-xs font-bold text-gold-500 shadow-sm md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2"
                      aria-hidden
                    >
                      {item.year.slice(2)}
                    </div>
...
function TimelineCard({
  ...
  return (
    <div
      className={cn(
        "rounded-xl border border-navy-700 bg-navy-800 p-5 shadow-sm md:max-w-md",
